...
function popularMovies(){
    axios.get('https://api.themoviedb.org/3/movie/popular?api_key=80b747723113ce82af58357242c61035&language=en-US&page=1')
        .then((response) => {
...
function getReviews(){
    let movieId = sessionStorage.getItem('id');
        axios.get(`https://api.themoviedb.org/3/movie/${movieId}/reviews?api_key=80b747723113ce82af58357242c61035&language=en-US&page=1`)
            .then((response) => {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 box2">
                                            ...
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item active">
                                                    <strong>Original Title: </strong> ${movie.original_title}</li>
                                                <li class="list-group-item active">
                                        ...
                                        <div class="col-md-4 box3">
                                            ...
                                            <br>
                                            <div>
                                                <a href="https://www.themoviedb.org/movie/${movie.id}/videos" target="_blank" class="btn-one">Trailer</a>
                                            </div>
                                        </div>
                                    </div>
                                `
                        ...
                        output += `
                            <div class="col-md-3 box">
                                <div class="movieBox">
                                    <img src="${poster}" alt="poster" width="210" height="315" class="img">
                                        <div class="browse-movie-bottom">
                                            <a href="#" onclick="movieSelected('${tv.id}')" class="browse-movie-title">${tv.title}</a>
                                            <div class="browse-movie-year">${year}</div>
                                            <button type="submit" class="button" onclick="movieSelected('${tv.id}')">Movie Details</button>
                                        </div>
                                </div>
                            </div>
                        `
