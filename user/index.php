<?php
    session_start();
    if(!isset($_SESSION['username'])){// se não estiver logado
        header('location: ../guest/index.php');// redireciona para a pagina de login
    }else{// se estiver logado
        if($_SESSION['status'] == "admin"){// se for admin
                    ...
                    <div class=" inner-body ">
                        ...
                        <p style="color: white" class="content">
                            ...
                            <span style="font-weight:bold; color: #6AC045">Information</span> for each and every released and not released movies. We are providing this information
                                    by the help of
                            <span style="font-weight:bold; color: #6AC045">Movie Database </span> which known for their movies resources.
                            <span style="font-weight:bold; color: #6AC045">Browse</span> Movie and get detail aspect of your favourite movie.
                        </p>
                    </div>
                    <div class="container">
                        <a href="browse.php" class="btn-main btn-main-primary">Browse Movies Now</a>
                    </div>
                </center>
            </div>
        </header>
